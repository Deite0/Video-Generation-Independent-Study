...
if __name__ == "__main__":
    ...
    input_folder = r"/media/namrata/NAMRATA/Independent Study/Video-Generation-Independent-Study3/dataset"
    
    # Text file to save results
    output_file = r"/media/namrata/NAMRATA/Independent Study/Video-Generation-Independent-Study3/tc_scores.txt"
